...
{
    internal class TeacherRepository(IApplicationDbContext context) : IGenericRepository<Teacher>
    {
        ...
        Task<Teacher> IGenericRepository<Teacher>.GetByNameAsync(string name)
        {
            throw new NotImplementedException();
        }
