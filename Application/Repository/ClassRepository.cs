...
{
    public class ClassRepository(IApplicationDbContext context) : IGenericRepository<ClassTable>
    {
        ...
        Task<ClassTable> IGenericRepository<ClassTable>.GetByNameAsync(string name)
        {
