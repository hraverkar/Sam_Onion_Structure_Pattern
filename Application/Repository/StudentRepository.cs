...
{
    internal class StudentRepository(IApplicationDbContext context) : IGenericRepository<Student>
    {
        ...
        Task<Student> IGenericRepository<Student>.GetByNameAsync(string name)
        {
            throw new NotImplementedException();
        }
